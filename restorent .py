# -*- coding: utf-8 -*-
"""
Created on Mon Dec 27 12:54:31 2021
...
#-----------------INFO TOP------------
lblinfo = Label(Tops, font=( 'aria' ,30, 'bold' ),text="Gupta Restaurant ",fg="red",bd=10,anchor='w')
...
status = Label(f2,font=('aria', 15, 'bold'),width = 16, text=" -ByOmprakash kumar",bd=2,relief=SUNKEN)
